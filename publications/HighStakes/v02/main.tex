...
For larger phytoplankton, above 10 micron in size, the decrease in search time is more moderate, from a month to a week, but, depending gently on gradient detection abilities, it is more robust to variations.
...
%, while chemotaxis may be more pervasive than previously thought, outstanding questions related to its operational limits or its benefit to cell growth, may need to be answered individually for each specific system.
